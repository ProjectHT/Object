...
Object::Object(const Object& orig) {
    ...
    if (!this->type.empty()) {
        if (this->type.compare("char") == 0) {
            ...
            if (this->size == 1) {
                this->data = new Object(*((Object*)orig.data));
            }
            else {
                this->data = new Object[this->size];
                for (int i = 0; i < this->size; i++) {
                    ((Object*)(this->data))[i] = Object(((Object*)(orig.data))[i]);
                }
            }
        }
    }
...
string Object::convertToData() {
    ...
    if (type.compare("string") == 0) {
        if (this->size == 1) {
            ss << std::to_string(((string*)(this->data))->length()+2);
            ss << "\";data:";
            ss << "\"";
            ss << *((string*)(this->data));
            ss << "\"" << "}";
        ...
        if (this->size == 1) {
            string tmp = ((Object*)(this->data))->convertToData();
            ...
            int tmp_length = 0;
            for (int i = 0; i < this->size; i++) {
                tmp[i] = ((Object*)(this->data))[i].convertToData();
        ...
        if (this->type.compare("char") == 0)
            ...
            tmp_member_size = 8;
        if (this->size == 1) {
            string tmp = m_base64.encode((char*)this->data, tmp_member_size);
            ss << std::to_string(tmp.length());
            ss << "\";data:";
            ss << tmp;
            ss << "}";
            ...
            string tmp = m_base64.encode((char*)this->data, t_length);
            ss << std::to_string(tmp.length());
            ss << "\";data:";
            ss << tmp;
            ss << "}";
...
/*************************************************************************************************/
bool Object::convertFromData(string& input_data, int &index) {
    std::stringstream ss;
    ...
    if (this->type.compare("object") == 0) {
        ...
        for (;;) {
            ...
            if (!m_buffer.at(m_buffer.size() - 1).convertFromData(input_data, temp_index)) {
                ...
                this->data = new Object[this->size];
                for (int i = 0; i < this->size; i++) {
                    ((Object*)(this->data))[i] = Object(m_buffer.at(i));
                }
                return true;
            }
        }	
...
/*************************************************************************************************/
bool Object::checkData(string& input, int& index, string comp) {
    bool flag = true;
...
/*************************************************************************************************/
bool Object::findData(string& input, int& index, char data) {
